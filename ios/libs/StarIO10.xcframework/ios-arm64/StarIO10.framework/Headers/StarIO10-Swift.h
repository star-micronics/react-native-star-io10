...
typedef SWIFT_ENUM_NAMED(NSInteger, STARIO10StarPrinterModel, "StarPrinterModel", open) {
  ...
  STARIO10StarPrinterModelmC_Label3 SWIFT_COMPILE_NAME("mC_Label3") = 14,
  STARIO10StarPrinterModelSM_S210i SWIFT_COMPILE_NAME("sm_S210i") = 15,
  STARIO10StarPrinterModelSM_S230i SWIFT_COMPILE_NAME("sm_S230i") = 16,
  STARIO10StarPrinterModelSM_T300i SWIFT_COMPILE_NAME("sm_T300i") = 17,
  STARIO10StarPrinterModelSM_T400i SWIFT_COMPILE_NAME("sm_T400i") = 18,
  STARIO10StarPrinterModelSM_L200 SWIFT_COMPILE_NAME("sm_L200") = 19,
  STARIO10StarPrinterModelSM_L300 SWIFT_COMPILE_NAME("sm_L300") = 20,
  STARIO10StarPrinterModelBSC10 SWIFT_COMPILE_NAME("bsc10") = 21,
  STARIO10StarPrinterModelTSP043 SWIFT_COMPILE_NAME("tsp043") = 22,
  STARIO10StarPrinterModelSP700 SWIFT_COMPILE_NAME("sp700") = 23,
  STARIO10StarPrinterModelTUP500 SWIFT_COMPILE_NAME("tup500") = 24,
};
