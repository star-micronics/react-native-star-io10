...
typedef SWIFT_ENUM_NAMED(NSInteger, STARIO10StarPrinterModel, "StarPrinterModel", open) {
  ...
  STARIO10StarPrinterModelTSP043 SWIFT_COMPILE_NAME("tsp043") = 20,
  STARIO10StarPrinterModelSP700 SWIFT_COMPILE_NAME("sp700") = 21,
  STARIO10StarPrinterModelTUP500 SWIFT_COMPILE_NAME("tup500") = 22,
};
