...
#ifndef STARIO10REACTNATIVE_SWIFT_H
#define STARIO10REACTNATIVE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StarIO10ReactNative",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC19StarIO10ReactNative6APInfo")
...
SWIFT_CLASS("_TtCC19StarIO10ReactNative16StarXpandCommand5Bezel")
@interface Bezel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface Bezel (SWIFT_EXTENSION(StarIO10ReactNative))
@end

SWIFT_ENUM_FWD_DECL(NSInteger, STARIO10StarXpandCommandBezelLEDType)
...
SWIFT_CLASS("_TtCC19StarIO10ReactNative16StarXpandCommand6Buzzer")
@interface Buzzer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface Buzzer (SWIFT_EXTENSION(StarIO10ReactNative))
@end
...
typedef SWIFT_ENUM_NAMED(NSInteger, STARIO10StarXpandCommandBuzzerChannel, "Channel", open) {
  ...
  STARIO10StarXpandCommandBuzzerChannelNo3 = 2,
  STARIO10StarXpandCommandBuzzerChannelNo4 = 3,
};
...
SWIFT_CLASS("_TtC19StarIO10ReactNative15CurrentWLanInfo")
...
SWIFT_CLASS("_TtCC19StarIO10ReactNative16StarXpandCommand7Display")
@interface Display : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface Display (SWIFT_EXTENSION(StarIO10ReactNative))
@end
...
SWIFT_CLASS("_TtCC19StarIO10ReactNative16StarXpandCommand6Drawer")
@interface Drawer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface Drawer (SWIFT_EXTENSION(StarIO10ReactNative))
@end
...
typedef SWIFT_ENUM_NAMED(NSInteger, STARIO10StarXpandCommandDrawerChannel, "Channel", open) {
  ...
  STARIO10StarXpandCommandDrawerChannelNo3 = 2,
  STARIO10StarXpandCommandDrawerChannelNo4 = 3,
};
...
SWIFT_ENUM_FWD_DECL(NSInteger, STARIO10FirmwareUpdateStep)
...
SWIFT_CLASS("_TtC19StarIO10ReactNative11FoundAPInfo")
...
SWIFT_CLASS("_TtC19StarIO10ReactNative8Internal")
...
@interface MelodySpeaker (SWIFT_EXTENSION(StarIO10ReactNative))
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, STARIO10StarXpandCommandMelodySpeakerSoundStorageArea)
...
SWIFT_CLASS("_TtCC19StarIO10ReactNative16StarXpandCommand9Presenter")
@interface Presenter : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface Presenter (SWIFT_EXTENSION(StarIO10ReactNative))
@end

SWIFT_ENUM_FWD_DECL(NSInteger, STARIO10StarXpandCommandPresenterLEDType)
SWIFT_CLASS_NAMED("LEDAutomaticBlinkParameter")
...
SWIFT_CLASS("_TtCC19StarIO10ReactNative16StarXpandCommand7Printer")
@interface Printer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface Printer (SWIFT_EXTENSION(StarIO10ReactNative))
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, STARIO10StarXpandCommandPrinterBarcodeSymbology)
...
SWIFT_ENUM_FWD_DECL(NSInteger, STARIO10StarXpandCommandPrinterBlackMarkPosition)
...
SWIFT_ENUM_FWD_DECL(NSInteger, STARIO10StarXpandCommandPrinterTextWidthType)
...
typedef SWIFT_ENUM_NAMED(NSInteger, STARIO10ErrorCode, "StarIO10ErrorCode", open) {
  ...
  STARIO10ErrorCodeBluetoothLeDeviceIsNotPaired SWIFT_COMPILE_NAME("bluetoothLeDeviceIsNotPaired") = 2003,
...
@class NSDictionary;
@interface STARIO10ErrorDetail (SWIFT_EXTENSION(StarIO10ReactNative))
...
@interface STARIO10StarPrinter (SWIFT_EXTENSION(StarIO10ReactNative))
- (void)openWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion;
- (void)closeWithCompletion:(void (^ _Nonnull)(void))completion;
- (void)writeWithData:(NSData * _Nonnull)data timeout:(NSInteger)timeout completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
...
SWIFT_ENUM_FWD_DECL(NSInteger, STARIO10StarPrinterModel)
...
@interface STARIO10StarPrinterSettingFirmware (SWIFT_EXTENSION(StarIO10ReactNative))
...
@interface STARIO10StarPrinterStatus (SWIFT_EXTENSION(StarIO10ReactNative))
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull reserved;
@end
...
@property (nonatomic, readonly, strong) STARIO10NullableDrawerOpenedMethod * _Nullable nullableDrawer3OpenedMethod;
@property (nonatomic, readonly, strong) STARIO10NullableBool * _Nullable nullableDrawer3OpenCloseSignal;
@property (nonatomic, readonly, strong) STARIO10NullableDrawerOpenedMethod * _Nullable nullableDrawer4OpenedMethod;
@property (nonatomic, readonly, strong) STARIO10NullableBool * _Nullable nullableDrawer4OpenCloseSignal;
...
@property (nonatomic, readonly, strong) STARIO10NullableBool * _Nullable nullableExternalDevice3Connected;
@property (nonatomic, readonly, strong) STARIO10NullableBool * _Nullable nullableExternalDevice4Connected;
...
- (NSDictionary<NSString *, id> * _Nonnull)getAllProperties SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_CLASS("_TtC19StarIO10ReactNative17StarSettingDevice")
@interface StarSettingDevice : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC19StarIO10ReactNative40StarSettingDeviceDiscoveryManagerFactory")
...
SWIFT_CLASS("_TtC19StarIO10ReactNative15StarWLanSetting")
...
@interface STARIO10StarXpandCommand (SWIFT_EXTENSION(StarIO10ReactNative))
@end
...
SWIFT_CLASS("_TtC19StarIO10ReactNative24WLanSettingServiceStatus")
